...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 16 16:18:48 2018
...
files = ['feb1.xls','feb2.xls','feb3.xls']
...
for j in range(3):
    ...
    date = ['2009','2010','2011','2013','2014','2015','2017','2018']
    ...
    for m in range(10):
        if(m<8):
            variable_url = 'date='+date[m]+'-02-01&enddate='+date[m]+'-02-28&tp=24'
            url = main_url + variable_url
        else:
            variable_url = 'date='+date1[m-8]+'-02-01&enddate='+date1[m-8]+'-02-29&tp=24'
            url = main_url + variable_url
        #fetch the json data
